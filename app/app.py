...
def form_update_post(mlb_id):
    ...
    sql_update_query = """UPDATE mlb t SET t.Name = %s, t.Team = %s, t.Position = %s, t.Height_inches = 
...
def form_insert_post():
    ...
    sql_insert_query = """INSERT INTO mlb (Name, Team, Position, Height_inches, Weight_lbs, Age) VALUES (%s, %s,
    %s, %s,%s, %s) """
...
def form_delete_post(mlb_id):
    cursor = mysql.get_db().cursor()
    sql_delete_query = """DELETE FROM mlb WHERE id = %s """
